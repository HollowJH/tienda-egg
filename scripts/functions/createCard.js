	...
	return `
       <div class="product-card">
          ...
          <div class="product-info">
            <span class="product-title">${product.title} ${paginaCargada[1] == "cart.html" ? `<svg ${favouriteCheck(product.id) ? 'class="favourite"' : ""} id="heart" xmlns="http://www.w3.org/2000/svg" fill="${favouriteCheck(product.id) ? "#ff3535" : "none"}" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
